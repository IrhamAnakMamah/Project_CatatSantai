...
class LogoutConfirmationDialog extends StatelessWidget {
  // Fungsi yang akan dipanggil jika user menekan tombol 'Ya'
          ...
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  'Yakin ingin log out?', // Teks konfirmasi logout
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      onLogoutConfirmed(); // Panggil fungsi konfirmasi logout
                    },
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Colors.red[600], // Warna merah untuk tombol Ya
